    ...
    <div className="flex flex-col h-full bg-white relative">
      <div className="flex-1 overflow-y-auto p-5 space-y-6 pb-24">
        ...
        <div>
          ...
          <div className="flex items-center border-2 border-gray-200 rounded-xl overflow-hidden focus-within:border-[#2E8B8B] transition-colors">
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2 mb-3">
            {attendees.map(a => (
              <div key={a.id} className="flex items-center gap-1.5 bg-[#eaf5f5] text-[#1B2A4A] px-3 py-1.5 rounded-full text-sm font-semibold border border-[#2E8B8B]/20">
                {a.name}
                {!a.isClaimant ? (
                  <button onClick={() => removeAttendee(a.id)} className="text-[#2E8B8B] hover:text-[#1e6161]">
                  ...
                  <svg className="w-3.5 h-3.5 text-[#2E8B8B]" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="relative">
            <input
              ...
              className="w-full border-2 border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-[#2E8B8B]"
            />
          ...
          <div className="bg-gray-50 p-4 rounded-xl border border-gray-100">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="flex bg-gray-200 p-1 rounded-lg">
                <button onClick={() => setSplitMode('equal')} className={`px-3 py-1 text-xs font-bold rounded-md transition-colors ${splitMode === 'equal' ? 'bg-white shadow-sm text-[#1B2A4A]' : 'text-gray-500 hover:text-gray-700'}`}>Equally</button>
                <button onClick={() => setSplitMode('custom')} className={`px-3 py-1 text-xs font-bold rounded-md transition-colors ${splitMode === 'custom' ? 'bg-white shadow-sm text-[#1B2A4A]' : 'text-gray-500 hover:text-gray-700'}`}>Custom</button>
              </div>
            </div>
                  ...
                  <div key={a.id} className="flex items-center justify-between">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-24 border border-gray-200 rounded-lg pl-7 pr-2 py-1.5 text-sm text-right focus:outline-none focus:border-[#2E8B8B]"
                      />
                    </div>
                  </div>
                ))}
