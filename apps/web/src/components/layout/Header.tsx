  ...
  return (
    <header className="bg-white border-b border-[#E8ECF2] h-16 flex items-center justify-between px-6 z-10 sticky top-0 shadow-sm shadow-gray-100/50">
       <div className="flex items-center text-sm font-medium text-gray-500 gap-2">
         <span className="text-[#000053] cursor-pointer hover:underline font-semibold">Workspace</span>
       ...
       <div className="flex items-center gap-4">
         <div className="relative">
            ...
            <input type="text" placeholder="Search..." className="w-64 pl-10 pr-4 py-2 bg-gray-50 hover:bg-gray-100 transition-colors border max-w-full border-gray-200 rounded-full text-sm focus:bg-white focus:border-[#6cffc6] focus:ring-1 focus:ring-[#6cffc6] outline-none" readOnly suppressHydrationWarning />
         </div>
         <button onClick={() => setShowNotif(true)} className="relative text-gray-500 hover:text-[#000053] transition-colors p-2">
