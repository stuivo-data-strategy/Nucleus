    ...
    <header className="bg-white border-b border-[#E8ECF2] h-16 flex items-center justify-between px-6 z-10 sticky top-0 shadow-sm shadow-gray-100/50">
       ...
       <div className="flex items-center gap-4">
         <div className="relative">
            ...
            <input type="text" placeholder="Search..." className="w-64 pl-10 pr-4 py-2 bg-gray-50 hover:bg-gray-100 transition-colors border max-w-full border-gray-200 rounded-full text-sm focus:bg-white focus:border-[#2E8B8B] focus:ring-1 focus:ring-[#2E8B8B] outline-none" readOnly />
         </div>
