   ...
   return (
     <div className="max-w-5xl mx-auto space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
        <div className="bg-white rounded-3xl border border-gray-200 shadow-sm relative overflow-hidden group hover:shadow-md transition-shadow">
           <div className="absolute top-0 left-0 right-0 h-32 bg-[#000053] overflow-hidden">
           ...
           <div className="relative pt-12 px-8 pb-8 flex flex-col md:flex-row gap-6 md:gap-10 items-center md:items-start text-center md:text-left border-b border-gray-100">
              <Avatar name={`${person.first_name} ${person.last_name}`} size="lg" className="w-36 h-36 text-4xl ring-8 ring-white shadow-xl bg-white text-[#000053] font-bold shrink-0 -mt-6" />
              <div className="flex-1 pt-2 md:pt-4">
                 ...
                 <div className="flex flex-wrap justify-center md:justify-start items-center gap-4 mt-6 text-sm text-gray-500">
                    ...
                    <span className="font-mono bg-white px-3 py-1.5 rounded-lg border border-gray-200 text-xs text-gray-500 font-bold shadow-sm flex items-center gap-2"><span>ID</span><span className="text-[#000053]">{person.employee_id}</span></span>
                 </div>
              </div>
           </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 pt-2">
           <div className="lg:col-span-2 space-y-6">
              <Card className="p-8 border-gray-200 shadow-sm">
                 <h2 className="text-xl font-bold text-[#000053] mb-6 flex items-center gap-3">
                 ...
                 <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-8 gap-x-8">
                    <div className="bg-gray-50 p-4 rounded-xl border border-gray-100">
                       ...
                       <dd className="font-bold text-[#000053] capitalize text-lg">{(person.org_unit||'').replace('org_unit:','').replace('_',' ')}</dd>
                    </div>
                    <div className="bg-gray-50 p-4 rounded-xl border border-gray-100">
                    ...
                    <div className="bg-gray-50 p-4 rounded-xl border border-gray-100">
                       ...
                       <dd className="font-bold text-[#000053] hover:underline cursor-pointer text-lg">{person.manager_info ? `${person.manager_info.first_name} ${person.manager_info.last_name}` : 'CEO / Board'}</dd>
                    </div>
                    <div className="bg-gray-50 p-4 rounded-xl border border-gray-100">
           ...
           <div className="space-y-6">
              <Card className="p-6 border-t-[6px] border-t-[#6cffc6] shadow-sm">
                 <h2 className="text-lg font-bold text-[#000053] mb-5 border-b border-gray-100 pb-3">Line Management</h2>
                    ...
                    <div className="space-y-4">
                       ...
                       {person.direct_reports.map((dr:any) => (
                           <div key={dr.id} className="flex items-center gap-4 p-2 hover:bg-teal-50 rounded-lg group transition-colors cursor-pointer border border-transparent hover:border-teal-100">
                              ...
                              <div>
                                 <div className="text-sm font-bold text-gray-700 group-hover:text-[#000053] transition-colors">{dr.first_name} {dr.last_name}</div>
